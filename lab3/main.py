...
if __name__ == '__main__':
    ...
    p_w = []
    for i in range(1, 8):
        p_c.append(open("../lab2/benchmarks/p0" + str(i) + "_c.txt", "r"))
        p_p.append(open("../lab2/benchmarks/p0" + str(i) + "_p.txt", "r"))
        p_s.append(open("../lab2/benchmarks/p0" + str(i) + "_s.txt", "r"))
        p_w.append(open("../lab2/benchmarks/p0" + str(i) + "_w.txt", "r"))
